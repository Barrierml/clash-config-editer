...
interface PoolEditorProps {
  ...
  onRemoveMany: (id: string, nodeNames: string[]) => void;
  onClearPool: (id: string) => void;
}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <Button
                      ...
                      variant="outline"
                      size="sm"
                      disabled={selectedNodes.length === 0 || pool.proxies.length === 0}
                      onClick={() => onRemoveMany(pool.id, selectedNodes)}
                    >
                      Remove selected
                    </Button>
                    <Button
